...
const getCurrentLocation = () => {
  ...
  Geolocation.getCurrentPosition(
    ...
    (error) => {
      ...
      Alert.alert('Error', 'Failed to get location. Please check your settings and try again.');
    },
     ...
     <Input
      ...
      <Input
        ...
        onChangeAccountNo={(text) =>
          setWasteDetails((prevDetails) => ({
            ...prevDetails,
            pickupLocation: checked ? wasteDetails.currentAddress : text,
          }))
        }
      />
        <Text>{wasteDetails.currentAddress}</Text>
      ...
      <Text style={styles.alert}>We’ve added a 10% fee to your waste schedules for your convenience.</Text>
